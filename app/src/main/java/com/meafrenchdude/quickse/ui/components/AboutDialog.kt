    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                LabeledText(label = "Original App Developer", value = "maazm7d", url="https://github.com/maazm7d")
                LabeledText(label = "QuickSE: Monet Developer", value = "A French Dude", url="https://github.com/meafrenchdude")
